...
import com.xrest.buysell.Retrofit.ProductRepo
...
edt.hint ="${data}"
    ...
    override fun onClick(v: View?) {
        ...
        {
            R.id.register -> {
                var product = Product(Name= name.text.toString(),UsedFor = used.text.toString().toInt(),Price = price.text.toString(),Description = description.text.toString(),Negotiable = nogotiable,Category = acategory, Condition = acondition,SoldOut = false)
                post(product)
            }
            R.id.search -> {
    ...
    fun uplloadImage(id:String){
        ...
        dialog.setContentView(R.layout.header_layout)
