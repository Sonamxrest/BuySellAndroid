...
object :BiometricPrompt.AuthenticationCallback(){
    ...
    override fun onCreateView(
        ...
        if(preferences.getBoolean("biometric",false)==true)
        {
            ...
            bio.isVisible =true
            biometricPrompt = BiometricPrompt.Builder(requireContext()).setTitle("FingerPrint Login").setNegativeButton("Cancel",executor,DialogInterface.OnClickListener(){ dialog, which ->
                dialog.cancel()
        ...
        when(count){
            ...
            1->{
                ...
                answer.isVisible=true
                    ...
                    question.text =  qa[index].question
                    next.setOnClickListener(){
